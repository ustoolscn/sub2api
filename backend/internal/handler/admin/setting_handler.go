...
func (h *SettingHandler) GetSettings(c *gin.Context) {
	...
	payload := dto.SystemSettings{
		...
		PhoneSMSAliyunAccessKeyID:                              settings.PhoneSMSAliyunAccessKeyID,
		PhoneSMSAliyunAccessKeySecretConfigured:                settings.PhoneSMSAliyunAccessKeySecretConfigured,
		PhoneSMSAliyunSignName:                                 settings.PhoneSMSAliyunSignName,
		PhoneSMSAliyunTemplateCode:                             settings.PhoneSMSAliyunTemplateCode,
		PhoneSMSAliyunTemplateParamKey:                         settings.PhoneSMSAliyunTemplateParamKey,
