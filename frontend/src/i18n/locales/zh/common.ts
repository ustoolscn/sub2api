export default {
  ...
  auth: {
    ...
    phoneCodePlaceholder: '请输入短信验证码',
    phoneCodeSentSuccess: '验证码已发送，请查收短信。',
    phoneInvitationHint: '首次用该手机号登录会自动注册；若站点开启了邀请码，请填写。',
    passwordLabel: '密码',
    ...
    errors: {
      ...
      PHONE_LOGIN_DISABLED: '手机号登录未开启',
      SMS_NOT_CONFIGURED: '短信服务未配置',
      ...
      OAUTH_INVITATION_REQUIRED: '首次注册需要邀请码',
