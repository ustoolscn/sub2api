export default {
  ...
  auth: {
    ...
    phoneCodePlaceholder: 'Enter the SMS code',
    phoneCodeSentSuccess: 'Verification code sent. Check your SMS.',
    phoneInvitationHint: 'The first login with this number creates an account. Enter an invitation code if the site requires one.',
    ...
    errors: {
      ...
      PHONE_ALREADY_BOUND: 'This phone number is already bound to another account',
      SMS_SEND_FAILED: 'Failed to send SMS. Please try again later.',
      INVALID_VERIFY_CODE: 'Invalid or expired verification code',
      VERIFY_CODE_TOO_FREQUENT: 'Please wait before requesting another code',
      OAUTH_INVITATION_REQUIRED: 'An invitation code is required to register',
