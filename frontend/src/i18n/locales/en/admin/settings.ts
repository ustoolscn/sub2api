export default {
    settings: {
      ...
      phoneLogin: {
        title: 'Phone Login',
        description: 'Sign in or register with an Aliyun SMS verification code. The first unused number auto-creates an account when registration is open.',
        enable: 'Enable phone login',
        enableHint: 'Shows a phone + SMS code tab on the login page. Aliyun SMS settings are required.',
        accessKeyId: 'AccessKey ID',
        accessKeyIdPlaceholder: 'LTAI...',
        accessKeySecret: 'AccessKey Secret',
        accessKeySecretPlaceholder: '********',
        accessKeySecretHint: 'Used to call Aliyun SMS. Keep it secret.',
        accessKeySecretConfiguredHint: 'Secret configured. Leave empty to keep the current value.',
        signName: 'SMS sign name',
        signNamePlaceholder: 'e.g. Sub2API',
